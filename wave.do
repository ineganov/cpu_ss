...
add wave -noupdate /testbench/CLK_CPU
...
add wave -noupdate -divider <NULL>
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/pc_f1
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/pc_f2
...
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/pc_m1
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/pc_m2
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/pc_w
add wave -noupdate -divider <NULL>
add wave -noupdate /testbench/mcpu/the_datapath/ien_f1
add wave -noupdate /testbench/mcpu/the_datapath/ien_f2
add wave -noupdate /testbench/mcpu/the_datapath/ien_d
add wave -noupdate /testbench/mcpu/the_datapath/ien_e
add wave -noupdate /testbench/mcpu/the_datapath/ien_m1
add wave -noupdate /testbench/mcpu/the_datapath/ien_m2
...
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/src_a_fwd_e
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/src_b_e
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/src_b_fwd_e
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/aluout_e
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/aluout_final_e
add wave -noupdate -divider <NULL>
...
add wave -noupdate -radix hexadecimal /testbench/mcpu/the_datapath/rf_unit/WR_ADDR_3
...
WaveRestoreCursors {{Cursor 1} {358884 ps} 0}
